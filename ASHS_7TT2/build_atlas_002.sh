...
function PrepareAtlas_sub()
{
  ...
  echo "orig_${aid} $RAWATLASDIR/orig_$aid/orig_T2.nii.gz $RAWATLASDIR/orig_$aid/orig_T2.nii.gz $RAWATLASDIR/orig_$aid/orig_left_LW5.nii.gz $RAWATLASDIR/orig_$aid/orig_right_LW5.nii.gz" > \
  ...
  echo "flip_${aid} $RAWATLASDIR/flip_$aid/flip_T2.nii.gz $RAWATLASDIR/flip_$aid/flip_T2.nii.gz $RAWATLASDIR/flip_$aid/flip_left_LW5.nii.gz $RAWATLASDIR/flip_$aid/flip_right_LW5.nii.gz" >> $OUTTMPDIR/$(printf %04d $i)_${aid}.txt 
}
...
function CreateAtlas()
{
  ...
  $ASHS_ROOT/bin/ashs_train.sh \
    ...
    -w $RUNDIR \
    -C $ANALYSISDIR/ashs_user_config_7T_T2only.sh \
