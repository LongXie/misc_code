...
LABEL_IDS=(BKG             ERC  BA35 BA36 CS)
LABEL_MRG=("0 1 2 3 4 8"   "9"  "11" "12" "13")
LABEL_NEW=(0               1    2    3    4)
MESH_LABEL=(ERC BA35 BA36)
KINDS="tse mprage ${LABEL_IDS[*]}"
EVALLABELS=(ERC BA35 BA36 PRC   CS ALL)
RANGES=(    1   2   3     "2 3" 4  "1 2 3")
MESH_EVAL=(       ERC BA35 BA36 PRC   CS)
MESH_EVAL_RANGES=(1   2    3    "2 3" 4)

# Relevant labels
LABEL_FG=(ERC BA35 BA36 CS)
EXTRAMESHES=(PRC MRG)
