...
LABEL_IDS=(BKG                         CA      DG   SUB)
LABEL_MRG=("0 7 10 11 12 13 14 15 16"  "1 2 4" "3"  "8")
LABEL_NEW=(0                           1       2    3)
MESH_LABEL=(CA SUB)
KINDS="tse mprage ${LABEL_IDS[*]}"
EVALLABELS=(CA  DG   SUB  ALL)
RANGES=(    1   2    3    "1 2 3")
MESH_EVAL=(       CA DG SUB)
MESH_EVAL_RANGES=(1  2  3  )

# Relevant labels
LABEL_FG=(           CA DG SUB)
EXTRAMESHES=(MRG HIPPO)
#                BKG CA DG SUB 
EXTRAMESHESDEF=("-1  1  -1 1" \
                "-1  1  1  1")
...
function mean_thickness_sub()
{
  ...
  source $PKGDIR/matlab_batch.sh \
    ...
    $MESHGRPDIR/analysis/thick_${side}_DG.vtk
}
